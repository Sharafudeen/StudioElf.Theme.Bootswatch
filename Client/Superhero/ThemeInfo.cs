...
namespace StudioElf.Theme.Bootswatch.Superhero
{
    public class ThemeInfo : ITheme
    {
        public Oqtane.Models.Theme Theme => new Oqtane.Models.Theme
        {
            ...
            {
                new Stylesheet("https://cdnjs.cloudflare.com/ajax/libs/bootswatch/5.3.8/superhero/bootstrap.min.css", "sha512-zLLJUAiTdKB04iWjUxqOaalxI8pBIDufBkWdP7b5PNS1MvI3xdCZ4cW/wDMHZfrN/2y2/2CUVsSupYkTJUmRdQ==", "anonymous"),
                new Stylesheet("Themes/StudioElf.Theme.Bootswatch/Theme.css"),
                new Stylesheet($"Themes/StudioElf.Theme.Bootswatch/Superhero.css"),
