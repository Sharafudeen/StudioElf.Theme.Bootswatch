...
namespace StudioElf.Theme.Bootswatch.Journal
{
    public class ThemeInfo : ITheme
    {
        public Oqtane.Models.Theme Theme => new Oqtane.Models.Theme
        {
            ...
            {
                new Stylesheet("https://cdnjs.cloudflare.com/ajax/libs/bootswatch/5.3.8/journal/bootstrap.min.css", "sha512-Ylsu1JZm+ARmbxsN/6QcxZqmCnHG9sRWVjz8TEEHjspEwmFU2QT+VkQB9m2jZY203VpX37I/D7AdEsW9+Zurbw==", "anonymous"),
                new Stylesheet("Themes/StudioElf.Theme.Bootswatch/Theme.css"),
                new Stylesheet($"Themes/StudioElf.Theme.Bootswatch/Journal.css"),
